...
def main():
    ...
    args.model = 'Autoformer_Scaleformer'  # args.model =['PatchTST_ScaleFormer','AutoformerMS','NHits_Scaleformer']
    # We combine Scaleformer with Autoformer (Autoformer_Scaleformer), NHits (NHits_Scaleformer),
    # and PatchTST (PatchTST_ScaleFormer) to create three strong baselines.
    ...
    args.checkpoints = './checkpoints' + args.data + '_' + str(args.pred_len) + '/' + args.model + '/'
