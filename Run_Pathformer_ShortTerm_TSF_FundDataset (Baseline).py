...
def main():
    ...
    parser.add_argument('--PGA', action='store_true',
                        help='Period gated attention', default=True)
    ...
    if args.model == 'PathFormer':
        ...
        if pred_len_ == 10 or pred_len_ == 8:
            args.seq_len = 30
            args.layer_nums = 2
            ...
            args.seq_len = 30
            args.layer_nums = 2
            args.patch_size_list = [12, 8, 12, 8, 6, 8, 6, 12]
        args.num_nodes = 2
        args.k = 2
        args.d_model = 16
        args.d_ff = 64
