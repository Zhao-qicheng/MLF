...
class Dataset_ETT_hour(Dataset):
    ...
    def __read_data__(self):
        ...
        # self.df_time = df_raw['time'][border1:border2]
        # self.df_id = df_raw['id'][border1:border2]
    ...
    def __getitem__(self, index):
        ...
        # seq_id_x=self.df_time[s_begin:s_end]
        # seq_tim_x=self.df_id[s_begin:s_end]
        # seq_id_y = self.df_time[r_begin:r_end]
        # seq_tim_y = self.df_id[r_begin:r_end]
...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        # print('*******',self.flag,len(self.data_x) - self.seq_len - self.pred_len + 1)
        # print('111',self.flag,self.seq_len,self.pred_len,self.label_len)
        # time.sleep(400)
        self.data_stamp = data_stamp
    ...
    def __getitem__(self, index):
        ...
        seq_x_mark = self.data_stamp[s_begin:s_end]
        seq_y_mark = self.data_stamp[r_begin:r_end]
        # print('11',seq_x.shape,seq_y.shape,seq_x_mark.shape,seq_y_mark.shape)
        return seq_x, seq_y, seq_x_mark, seq_y_mark
...
class Dataset_Stock(Dataset):
    ...
    def __read_data__(self):
        ...
        # time.sleep(600)
        df_raw_y=df_raw[['date', 'Open', 'High', 'Low', 'Close', 'Adj Close', 'Volume']]
        df_raw_x=df_raw_y
    ...
    def __getitem__(self, index):
        ...
        seq_emb_id_x=self.data_stamp[s_begin:s_end]
        seq_emb_id_y = self.data_stamp[r_begin:r_end]
